...
//add listeners
	...
	option1.addActionListener((ActionListener) this);
    ...
    public void actionPerformed(ActionEvent e)
	{
		...
		{
		  JOptionPane.showMessageDialog(this, " 1. you can guess the word by clicking the character from the virtual keypad. \n2. you Can select a maximum of 5 incorrect letteres.\n3. The incorrect guess will highlighted with red color, and the correct one will be highlighted with green color.","Instructions",JOptionPane.INFORMATION_MESSAGE);
		}
